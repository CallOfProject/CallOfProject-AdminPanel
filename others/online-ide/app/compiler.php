<?php
    ...
    if($language == "Java") {
        $outputClass = $random . ".class"; // Java derlemesi .class dosyası oluşturur
        shell_exec("javac $filePath -d ."); // .class dosyasını mevcut dizine derle
        $output = shell_exec("java $outputClass"); // Java programını çalıştır
        echo $output;
    }